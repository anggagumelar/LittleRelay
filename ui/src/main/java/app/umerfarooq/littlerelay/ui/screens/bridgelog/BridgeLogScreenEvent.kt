...
sealed interface BridgeLogScreenEvent {
    data object OnClearLogsClick : BridgeLogScreenEvent
    data object OnBackClick : BridgeLogScreenEvent
    data object OnAutoScrollClick: BridgeLogScreenEvent
}
