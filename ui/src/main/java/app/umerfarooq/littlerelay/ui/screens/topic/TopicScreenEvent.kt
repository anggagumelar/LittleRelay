...
sealed interface TopicScreenEvent {
    data class OnAddNewTopic(val topic: Topic) : TopicScreenEvent
    data class OnDeleteTopicClick(val topic: Topic) : TopicScreenEvent
    data class OnUpdateTopicClick(val topic: Topic) : TopicScreenEvent
    data object OnBackClick : TopicScreenEvent
}
