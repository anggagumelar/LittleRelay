...
sealed interface DeviceServicesScreenEvent {
    data class OnNotifiableCharacteristicSelectionStateChange(
        val device: BleDevice,
        val bleCharacteristic: BleCharacteristic,
        val selected: Boolean
    ) : DeviceServicesScreenEvent

    data class OnWriteableCharacteristicSelectionStateChange(
        val device: BleDevice,
        val bleCharacteristic: BleCharacteristic,
        val selected: Boolean
    ) : DeviceServicesScreenEvent
