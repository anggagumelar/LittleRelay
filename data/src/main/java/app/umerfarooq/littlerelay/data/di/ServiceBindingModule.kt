...
import app.umerfarooq.littlerelay.data.service.BoundedServiceInstanceProviderImp
...
abstract class ServiceBindingModule {
    ...
    @Singleton
    @Binds
   abstract fun bindBoundedServiceInstanceProvider(
        boundedServiceInstanceProviderImp: BoundedServiceInstanceProviderImp
