 ...
 *
 */
package app.umerfarooq.littlerelay.domain.service
...
interface BoundedServiceInstanceProvider {
    val mqttService: StateFlow<MqttService?>
    val blePeripheralService: StateFlow<BlePeripheralService?>
    val bleToMqttBridgeService: StateFlow<BleToMqttBridgeService?>
    val bleCentralService: StateFlow<BleCentralService?>
