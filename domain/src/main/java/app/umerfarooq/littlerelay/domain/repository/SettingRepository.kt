 ...
 *
 */
package app.umerfarooq.littlerelay.domain.repository
...
interface SettingRepository {
    ...
    val bleConfig: Flow<BleConfig>

    suspend fun updateMqttConfig(mqttConfig: (config: MqttConfig) -> MqttConfig)
    suspend fun updateBleConfig(bleConfig: (config: BleConfig) -> BleConfig)
}
